...
Factory Preset は、削除しても、初期化すれば復活する。  
また、iOSアプリがあれば、バックアップファイルをZOOM社が公開していて、「１パッチ１ファイル」なので、欲しいものだけを選んで戻すことも可能。  
  
FactoryPresetsは、３通りのパターンがあり、  
1. エフェクター単体のパッチ。  
2. ２～３個のエフェクターを組み合わせたパッチ。  
3. 有名な曲の音をイメージしたパッチ。  
  
があり、「3.」について、知らない曲があれば聴いてみたり、音作りの参考にするとよい。  
  
| No  | Preset Name                     | Memo                                                    | 曲名                                | バンド名                               |
|-----|---------------------------------|---------------------------------------------------------|-----------------------------------|------------------------------------|
| 1   | 001 Krampus Drive               | 重厚な低域とブライトさを併せ持つZOOMオリジナルのプリアンプを使用したハイゲインサウンドです。        |                                   |                                    |
| 2   | 002 NewYork Fuzz                | 厚みのある轟音ファズサウンドです。                                       |                                   |                                    |
| 3   | 003 Squeak Distortion           | クラシックなディストーションサウンドです。                                   |                                   |                                    |
| 4   | 004 Pollex Drive                | ZOOMオリジナルのプリアンプを使用した歯切れの良いドライブサウンドです。                   |                                   |                                    |
| 5   | 005 Clone Chorus                | 深い変調がかかるアナログコーラスサウンドです。                                 |                                   |                                    |
| 6   | 006 Digital Delay               | クリアなデジタル・ディレイサウンドです。                                    |                                   |                                    |
| 7   | 007 Auto Wah                    | ピッキングの強弱に応じて効果がかかるオートワウサウンドです。                          |                                   |                                    |
| 8   | 008 Polyphonic Octaver          | 1オクターブ下の音を加えるオクターバーサウンドです。                              |                                   |                                    |
| 9   | 009 Phaser                      | 音にシュワシュワした揺らぎを加えるフェイザーサウンドです。                           |                                   |                                    |
| 10  | 010 Redloom Clean               | ZOOMオリジナルのプリアンプを使用した艶のあるクリーンサウンドです。                     |                                   |                                    |
| 11  | 011 Slapback Delay              | ロカビリーやカッティングに適した短いタイムのディレイサウンドです。                       |                                   |                                    |
| 12  | 012 Polyphonic Pitch Shifter    | 和音に対応したピッチシフターサウンドです。                                   |                                   |                                    |
| 13  | 013 MS1959 Drive                | 王道のドライブサウンドです                                           |                                   |                                    |
| 14  | 014 Orange Tremolo              | 音量を周期的に上下させるトレモロサウンドです。                                 |                                   |                                    |
| 15  | 015 Reverse Delay               | 入力音を逆再生する、リパース・ディレイサウンドです。                              |                                   |                                    |
| 16  | 016 Gold Drive                  | 金色のブティックペダルをモデリングしたドライブサウンドです。                          |                                   |                                    |
| 17  | 017 Chorus One                  | 爽やかなコーラスサウンドです。                                         |                                   |                                    |
| 18  | 018 Tape Echo 3                 | 太く温かみのあるテープエコーサウンドです。                                   |                                   |                                    |
| 19  | 019 Swell Vibrato               | ピッキング後に音程を揺らすビブラートサウンドです。                               |                                   |                                    |
| 20  | 020 Acoustic Simulator          | エレクトリックギターをアコースティックギター風のサウンドにします。                       |                                   |                                    |
| 21  | 021 OverDrive +Delay            | オーバードライブとディレイを使用した定番のリードサウンドです。                         |                                   |                                    |
| 22  | 022 Compressor +Chorus          | ポップスのバッキングギターの定番、コンプとコーラスを組み合わせたサウンドです。                 |                                   |                                    |
| 23  | 023 Tremolo +Spring Reverb      | トレモロとスプリングリバーブを使用したサーフロックの定番サウンドです。                     |                                   |                                    |
| 24  | 024 Distortion +Flanger         | ディストーションとフランジャーを使用したハードロックの定番サウンドです。                    |                                   |                                    |
| 25  | 025 Chorus+Delay +Reverb        | 空間系エフェクトの定番、コーラス、ディレイ、リバーブを組み合わせたサウンドです。                |                                   |                                    |
| 26  | 026 Smoking On The Window       | 20年代初期ポップロックのカッティングに適したクリーンサウンドです。                      | Smoking On The Window             | Bruno Mars                         |
| 27  | 027 Cosmic Sans                 | オートワウを使用した10年代後期アメリカのファンクに適したカッティングサウンドです。              | Cosmic Sans                       | Cory Wong                          |
| 28  | 028 GOAT                        | 10年代後期のプログレッシブロックに適したクランチサウンドです。                        | G.O.A.T.                          | Polyphia                           |
...
| 62  | 062 Room 335                    | 70年代後期JAZZ/FUSIONのギターインストに適したリードサウンドです。                 | Room 335                          | Larry Carlton                      |
